...
const initialChatState: Chat[] = getSafeSavedChats() || [
    ...
    },
    {
        ...
        content: [
            {
                emitter: "user",
                message: "Follow US on \nLinkedin [@Dream Potential](https://www.linkedin.com/company/dream-potential-serves-conscious-entrepreneurs/)\nInstagram [Dream Potential](https://instagram.com/)\nGitHub [Naman](https://github.com/Naman9761)"
            },
            {
                emitter: "gpt",
                message: "Thanks!"
